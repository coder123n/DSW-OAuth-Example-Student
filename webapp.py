...
def logout():
    ...
    return render_template('home.html', message=message)#'You were logged out')
...
def renderPage2():
    if 'user_data' in session:
        user_data_pprint = 'Number of public repositories:' + pprint.pformat(session['user_data']['public_repos'])#format the user data nicely
    else:
        user_data_pprint = '';
